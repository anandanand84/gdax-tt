...
import { ProductMap } from 'gdax-trading-toolkit/build/src/exchanges/ProductMap';
...
const EXCHANGE:string = process.env.Exchange || "Bitfinex";
...
async function start() {
    ...
    factories[EXCHANGE].FeedFactory(logger, [product]).then((feed: GDAXFeed) => {
